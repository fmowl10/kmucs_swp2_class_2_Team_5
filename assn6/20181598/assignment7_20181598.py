...
from dictionary import constantList, functionList, constantThings, functionThings
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text() + constantThings[constantList.index(key)][1])
        elif key in functionList:
            n = self.display.text()
            value = functionThings[functionList.index(key)][1](n)
